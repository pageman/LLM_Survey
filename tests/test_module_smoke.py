...
class RetrievalAndRAGSmokeTests(unittest.TestCase):
    ...
    def test_icl_cot_self_consistency_and_planning(self):
        ...
        self.assertGreater(SelfConsistencyDemo().evaluate()["gain"], 0.0)
        self.assertGreater(PlanningAgentDemo().evaluate()["success_rate"], 0.0)
        self.assertGreater(ReActDemo().evaluate()["grounded_reasoning_score"], 0.0)
        ...
        self.assertGreater(ToolformerStyleDemo().evaluate()["tool_call_rate"], 0.0)
