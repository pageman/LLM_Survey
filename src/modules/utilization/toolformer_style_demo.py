...
ToolAnnotation: TypeAlias = dict[str, object]
...
class ToolformerStyleDemo:
    ...
    def annotate(self, query: str) -> ToolAnnotation:
        ...
        accepted_call = bool(tool_called and counterfactual_gain > 0.0)
        return {
            "query": query,
    ...
    def evaluate(self) -> dict[str, object]:
        ...
        accepted_call_rate = sum(item["accepted_call"] for item in annotations) / len(annotations)
